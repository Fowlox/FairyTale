...
public class StoryActivity extends Activity implements StoryLayout.Listener {
	...
	private MediaPlayer story_sound; //占쎈뮞占쎈꽅�뵳占� 占쎌벉占쎈툢 占쎌삺占쎄문占쎌뒠
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		story_sound = new MediaPlayer();//Media player 占쎄문
		story_sound.setLooping(false);//獄쏆꼶�궗 占쎄퐬占쎌젟 占쎈퉸占쎌젫
	...
	//占쎈뮞占쎈꽅�뵳占�(占쎈꺖�뵳占�) 占쎌뵬占쎈뻻占쎌젟筌욑옙 占쎈솚占쎈씜�빊遺쏙옙占쎈퉸占쎈튊占쎈맙
	...
	public void pauseBtnHandler() {
		...
		//占쎌뵬占쎈뻻占쎌읅占쎌몵嚥∽옙 占쎈꽅占쎈뮞占쎈뱜 占쎌뵠�겫占썽겫袁⑹뱽 占쎈솚占쎈씜�뀎怨뺤쨮 癰귨옙野껓옙
