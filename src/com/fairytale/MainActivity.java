...
//        String detail_data = model.getDetail();
//        layout.viewDetail(det);
    }
        ...
        switch (keyCode) {
            case KeyEvent.KEYCODE_BACK:
                new AlertDialog.Builder(this)
                        .setTitle("醫낅즺")
                        .setMessage("醫낅즺 �븯�떆寃좎뒿�땲源�?")
                        .setPositiveButton("�삁", new DialogInterface.OnClickListener() {
...
//                                myAsync.stop();
                        ...
                        .setNegativeButton("�븘�땲�삤", null).show();
                return false;
            default:
                return false;
        }
